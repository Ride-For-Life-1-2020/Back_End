...
| ---- | :----: | :---------------: |  ---------------: |
| /api/drivers/signup |  POST  |  FullName (<strong>Required</strong>),<br/> UserName (<strong>Required & Unique</strong>),<br/> Password (<strong>Required</strong>), <br/> PhoneNumber (<strong>Integer (*10 Char Max*) & Required</strong>),<br/> Vehicle,<br/> Shift,<br/> <strong> Price </strong>,<br/> Email, <br/> City (<strong>Required</strong>)       | No |
...
| /api/drivers/:id |  DELETE  |           | <strong> Requires: 'authorization' header</strong>| 
...
| /api/patients/:id |  GET  |               | <strong> Requires: 'authorization' header</strong>|
...
| /api/patients/:id |  DELETE  |           | <strong> Requires: 'authorization' header</strong>| 
